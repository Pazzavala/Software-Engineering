...
class InstantRunoffTest {
    ...
    void runElectionClearWinner1() {
        AuditFile auditFile = new AuditFile("IRTestFile1.csv", "3/20/2023");
    ...
    void runElectionClearWinner2() {
        AuditFile auditFile = new AuditFile("IRTestFile2.csv", "3/20/2023");
        auditFile.collectFileInfo();
        InstantRunoff ir = new InstantRunoff(auditFile);
        Candidate winner = ir.runElection();
    ...
    void runElectionClearWinner3() {
        AuditFile auditFile = new AuditFile("IRTestFile3.csv", "3/20/2023");
        auditFile.collectFileInfo();
        InstantRunoff ir = new InstantRunoff(auditFile);
        Candidate winner = ir.runElection();
    ...
    void runElectionTieLowest1() {
        AuditFile auditFile = new AuditFile("IRTieTestFile3.csv", "3/20/2023");
        auditFile.collectFileInfo();
        InstantRunoff ir = new InstantRunoff(auditFile);
        Candidate winner = ir.runElection();
        assertEquals("Kleinberg", winner.getName());
    ...
    void runElectionTieLowest2() {
        AuditFile auditFile = new AuditFile("IRTieTestFile4.csv", "3/20/2023");
        auditFile.collectFileInfo();
        InstantRunoff ir = new InstantRunoff(auditFile);
        Candidate winner = ir.runElection();
        String name;
    ...
    void runElectionRedistributeWinner1() {
        AuditFile auditFile = new AuditFile("IRTieTestFile1.csv", "3/20/2023");
        auditFile.collectFileInfo();
        InstantRunoff ir = new InstantRunoff(auditFile);
        Candidate winner = ir.runElection();
        assertEquals("Kleinberg", winner.getName());
    ...
    void runElectionRedistributeWinner2() {
        AuditFile auditFile = new AuditFile("IRTieTestFile2.csv", "3/20/2023");
        auditFile.collectFileInfo();
        InstantRunoff ir = new InstantRunoff(auditFile);
        Candidate winner = ir.runElection();
    ...
    void runElectionRedistributeWinner3() {
        AuditFile auditFile = new AuditFile("IRTieTestFile6.csv", "3/20/2023");
        auditFile.collectFileInfo();
        InstantRunoff ir = new InstantRunoff(auditFile);
        Candidate winner = ir.runElection();
        assertEquals("Chou", winner.getName());
    ...
    void runElectionTieWinners1() {
        AuditFile auditFile = new AuditFile("IRTieTestFile5.csv", "3/20/2023");
        auditFile.collectFileInfo();
        InstantRunoff ir = new InstantRunoff(auditFile);
        Candidate winner = ir.runElection();
    ...
    @Test
    void dropCandidate1() {
        AuditFile auditFile = new AuditFile("IRTieTestFile1.csv", "3/23/2023");
        auditFile.collectFileInfo();
        InstantRunoff ir = new InstantRunoff(auditFile);
    ...
    void distributeBallot1() {
        AuditFile auditFile = new AuditFile("CoinFlip.csv", "3/23/2023");
        auditFile.collectFileInfo();
        InstantRunoff ir = new InstantRunoff(auditFile);
